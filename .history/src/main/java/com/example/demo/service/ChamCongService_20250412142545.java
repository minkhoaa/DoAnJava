...
public class ChamCongService {
    ...
    public ApiResponse getAttendance(Long employeeId, LocalDate date, Integer month) {
        ...
        if (employeeId != null && date != null) {
            attendanceList = chamCongRepository.findByNhanVienIdAndNgay(employeeId, date);
        } else if (employeeId != null && month != null) {
            attendanceList = chamCongRepository.findByNhanVienIdAndMonth(employeeId, month);
        } else {
    ...
    public ApiResponse checkOut(ChamCongDto chamCongDto) {
        List<ChamCong> chamCongList = chamCongRepository.findByNhanVienIdAndNgay(
