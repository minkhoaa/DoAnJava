...
public class PhongBanController {
    ...
    @DeleteMapping("/deletePhongBan/{id}")
    public ResponseEntity<ApiResponse> deletePhongban(@PathVariable Long id) {
        return ResponseEntity.ok(phongBanService.deletePhongBan(id));
    }
